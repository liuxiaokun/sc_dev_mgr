...
public class TableInfo {
    ...
    public void processTable() {
        ...
        this.lowerEntityName = toLowerCaseFirstOne(entityName);
        ...
        this.lowerServiceName = toLowerCaseFirstOne(this.serviceName);
    ...
    public String getLowerServiceName() {
